    ...
    <div class="section-card">
      ...
      <div class="section-body">
        ...
        <div class="search-bar-wrap">
          ...
          <button type="button" class="btn-gps" onclick="loadStatusData(true)">🔄 Sync Now</button>
        </div>
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Background fetch latest data & setup 20-second silent auto-polling
  loadStatusData();
...
async function executeSubmission() {
  ...
  renderStatusTable();
  triggerBrowserNotification("✅ Application Submitted!", "Request for " + merchantTitle + " submitted under SOL " + (newItem.SOL_ID || ""));
  showToast('✅ Submission recorded instantly!', 'success');
